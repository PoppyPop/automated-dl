...
class TestMediaDetection:
    ...
    def test_is_media_file_mkv(self):
...
class TestEpisodeDetection:
    ...
    def test_is_episode_movie(self):
    ...
    def test_is_episode_high_season_numbers(self):
    ...
    def test_is_episode_with_spaces_and_dots(self):
...
class TestSonarrRadarrAPITrigger:
    ...
    def test_sonarr_not_configured(self, caplog):
    ...
    def test_radarr_not_configured(self, caplog):
    ...
    @patch("httpx.post")
    def test_sonarr_api_call_success(self, mock_post, caplog):
    ...
    @patch("httpx.post")
    def test_radarr_api_call_success(self, mock_post, caplog):
    ...
    @patch("httpx.post")
    def test_sonarr_api_call_failure(self, mock_post, caplog):
        """Test Sonarr API call error handling."""
        caplog.set_level("ERROR")
        mock_post.side_effect = Exception("Connection error")

    @patch("httpx.post")
    def test_radarr_api_call_failure(self, mock_post, caplog):
    ...
    @patch("httpx.post")
    def test_sonarr_api_call_timeout(self, mock_post, caplog):
    ...
    @patch("httpx.post")
    def test_radarr_api_call_timeout(self, mock_post, caplog):
...
class TestIntegration:
    ...
    @patch("httpx.post")
    def test_episode_download_triggers_sonarr(self, mock_post, tmp_path, port, caplog):
    ...
    @patch("httpx.post")
    def test_movie_download_triggers_sonarr(self, mock_post, tmp_path, port, caplog):
        """Test that downloading an episode triggers Sonarr scan."""
        caplog.set_level("INFO")
        mock_response = MagicMock()
        mock_response.raise_for_status.return_value = None
    ...
    @patch("httpx.post")
    def test_non_media_file_no_api_call(self, mock_post, tmp_path, port):
